document.addEventListener('DOMContentLoaded', () => {
    ...
    if (heroVideo) {
        ...
        // Start muted to bypass browser policies
        ...
        // Double click on desktop to toggle audio mute
        heroVideo.addEventListener('dblclick', (e) => {
            e.stopPropagation();
            heroVideo.muted = !heroVideo.muted;
            wasMutedByUser = heroVideo.muted;
            if (!heroVideo.muted) {
        ...
        // Double tap on mobile to toggle audio mute
        let lastTap = 0;
